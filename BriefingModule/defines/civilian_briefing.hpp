if ((missionNamespace getVariable ["UO_FW_BRIEFING_CIVILIAN_FILE",false])) exitwith {
...
if ((missionNamespace getVariable ["UO_FW_BRIEFING_CIVILIAN_NATO",false]) && !(missionNamespace getVariable ["UO_FW_BRIEFING_CIVILIAN_WARSAW",false])) then {
	//Situation
	NEWTAB("I. Situation:")
	...
	"<font color='#5BD527'><h1>Disposition:</h1></font color><br/>" + (missionNamespace getVariable ["UO_FW_BRIEFING_CIVILIAN_NATO_ENEMY_DIS",""])  + "<br/><br/>" +
	"<font color='#5BD527'><h1>Strength:</h1></font color><br/>" + (missionNamespace getVariable ["UO_FW_BRIEFING_CIVILIAN_NATO_ENEMY_STRENGTH",""])  + "<br/><br/>" +
	...
	"<font color='#5BD527'><h1>Disposition:</h1></font color><br/>" + (missionNamespace getVariable ["UO_FW_BRIEFING_CIVILIAN_NATO_FRIENDLY_DIS",""])  + "<br/><br/>" +
	"<font color='#5BD527'><h1>Higher Units:</h1></font color><br/>" + (missionNamespace getVariable ["UO_FW_BRIEFING_CIVILIAN_NATO_FRIENDLY_HIGHER",""])  + "<br/><br/>" +
	"<font color='#5BD527'><h1>Strength:</h1></font color><br/>" + (missionNamespace getVariable ["UO_FW_BRIEFING_CIVILIAN_NATO_FRIENDLY_STRENGTH",""])  + "<br/><br/>" +
	"<font color='#5BD527'><h1>Appearance:</h1></font color><br/>" + (missionNamespace getVariable ["UO_FW_BRIEFING_CIVILIAN_NATO_FRIENDLY_APPEARANCE",""])  + "<br/><br/>"
	ENDTAB
	//Mission
	NEWTAB("II. Mission:")
...
if ((missionNamespace getVariable ["UO_FW_BRIEFING_CIVILIAN_WARSAW",false]) && !(missionNamespace getVariable ["UO_FW_BRIEFING_CIVILIAN_NATO",false])) then {
