...
if ((missionNamespace getVariable ["UO_FW_BRIEFING_BLUFOR_NATO",false]) && !(missionNamespace getVariable ["UO_FW_BRIEFING_BLUFOR_WARSAW",false])) then {
	//Situation
	NEWTAB("I. Situation:")
...
if ((missionNamespace getVariable ["UO_FW_BRIEFING_BLUFOR_WARSAW",false]) && !(missionNamespace getVariable ["UO_FW_BRIEFING_BLUFOR_NATO",false])) then {
