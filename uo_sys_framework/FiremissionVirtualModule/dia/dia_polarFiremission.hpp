...
#include "defs.hpp"
class FiremissionVirtual_DIA_POLARFIREMISSION {
	idd = POFM_DIA_IDD_DISPLAY;
	movingEnable = false;
	enableSimulation = true;
	scriptName = "FiremissionVirtual_Dialog_PolarFiremission";
	controlsBackground[] = {};
	objects[] = {};
	controls[] = {
			POFM_BACKGROUND,
	...
	class POFM_NUMGUNSTEXT: MGVAR(RscText)
	{
		idc = -1;
	...
	class POFM_FIREBUTTON: MGVAR(RscButton)
	{
		...
		h = ARTILAYOUTHEIGHT * safezoneH;
		shadow = 0;
		onMouseButtonDown = "[] call UO_FW_fnc_FiremissionVirtual_dia_PolarFiremissionFire;";
	};
	class POFM_SELECTEDGUNEDIT: MGVAR(RscListbox)
	{
		...
		//
		shadow = 0;
		onLBSelChanged = "(_this select 1) call UO_FW_fnc_FiremissionVirtual_dia_PolarFiremissionSetArtillery;";
	};
	...
	class POFM_NUMGUNEDIT: MGVAR(RscListbox)
	{
	...
	class POFM_CANCELBUTTON: MGVAR(RscButton)
	{
		...
		h = ARTILAYOUTHEIGHT * safezoneH;
		shadow = 0;
		onMouseButtonDown = "[] call UO_FW_fnc_FiremissionVirtual_dia_polarFiremissionCloseDialog;";
	};
};