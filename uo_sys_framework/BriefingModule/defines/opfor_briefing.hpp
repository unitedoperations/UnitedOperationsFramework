if (UO_FW_Briefing_OPFOR_File) exitwith {
...
if (UO_FW_Briefing_OPFOR_NATO) then {
    //Situation
    NEWTAB("I. Situation:")
    "<font color='#5BD527'><h1>Situation:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_SIT_Main + "<br/><br/>" +
    "<font color='#5BD527'><h1>Terrain:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_SIT_Terrain  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Key Terrain:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_SIT_KEYTerrain  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Weather:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_SIT_Weather
    ENDTAB
    //Enemy
    NEWTAB("   A. Enemy Forces:")
    "<font color='#5BD527'><h1>Disposition:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_Enemy_DIS  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Strength:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_Enemy_STRENGTH  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Equipment:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_Enemy_EQUIPMENT  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Appearance:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_Enemy_APPEARANCE  + "<br/><br/>" +
    "<font color='#5BD527'><h1>MLCOA:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_Enemy_MLCOA  + "<br/><br/>" +
    "<font color='#5BD527'><h1>MDCOA:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_Enemy_MDCOA
    ENDTAB
    //Friendly
    NEWTAB("   B. Friendly Forces:")
    "<font color='#5BD527'><h1>Disposition:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_FRIENDLY_DIS  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Higher Units:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_FRIENDLY_Higher  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Strength:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_FRIENDLY_STRENGTH  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Appearance:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_FRIENDLY_APPEARANCE  + "<br/><br/>"
    ENDTAB
    //Mission
    NEWTAB("II. Mission:")
    "<font color='#5BD527'><h1>Mission:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_Mission
    ENDTAB
    NEWTAB("III. Execution:")
    "<font color='#5BD527'><h1>Commanders Intent:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_EXECUTION_INTENT  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Maneuver:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_EXECUTION_MANEUVER  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Timings:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_EXECUTION_Timings  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Tasks:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_EXECUTION_Tasks
    ENDTAB
    NEWTAB("IV. Service Support:")
    ""
    ENDTAB
    NEWTAB("   A. Support:")
    "<font color='#5BD527'><h1>Fires:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_SANDS_SUPPORT_FIRES  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Ammo:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_SANDS_SUPPORT_AMMO
    ENDTAB
    NEWTAB("   B. Service:")
    "<font color='#5BD527'><h1>General:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_SANDS_SERVICE_GENERAL
    ENDTAB
    NEWTAB("V. Command & Signal:")
    ""
    ENDTAB
    NEWTAB("   A. Command:")
    "<font color='#5BD527'><h1>General:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_CANDS_COMMAND
    ENDTAB
    NEWTAB("   B. Signals:")
    "<font color='#5BD527'><h1>Frequencies:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_CANDS_Signals_FREQ  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Codewords:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_CANDS_Signals_CODEWORDS  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Special Signals:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_CANDS_Signals_SPECIAL  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Callsigns:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_CANDS_Signals_CALLSIGNS  + "<br/><br/>" +
    "<font color='#5BD527'><h1>Passwords:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_NATO_CANDS_Signals_PASSWORDS
    ENDTAB
};

if (UO_FW_Briefing_OPFOR_Warsaw) then {
    ...
    "<font color='#5BD527'><h1>End State Direction:</h1></font color><br/>" + UO_FW_Briefing_OPFOR_Warsaw_Mission_DIR
    ENDTAB
    NEWTAB("VI. Order:")
