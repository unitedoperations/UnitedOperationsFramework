if (GETMVAR(File_CIVILIAN,false)) exitwith {
    if !(GETMVAR(File_Path_CIVILIAN,"") isEqualto "") then {
        "" call (compile preprocessFileLineNumbers GETMVAR(File_Path_CIVILIAN,""));
    } else {
        ERROR("No briefing found for CIVILIAN!");
    };
};

if (GETMVAR(NATO_CIVILIAN,false)) then {
    //Situation
    private _situationStr = "";

    private _situationMain = GETMVAR(NATO_SIT_Main_CIVILIAN,"");
    ...
    private _situationTerrain = GETMVAR(NATO_SIT_Terrain_CIVILIAN,"");
    ...
    private _situationKey = GETMVAR(NATO_SIT_KEYTerrain_CIVILIAN,"");
    ...
    private _situationWeather = GETMVAR(NATO_SIT_Weather_CIVILIAN,"");
    ...
    private _enemyDisposition = GETMVAR(NATO_Enemy_DIS_CIVILIAN,"");
    ...
    private _enemyStrength = GETMVAR(NATO_Enemy_STRENGTH_CIVILIAN,"");
    ...
    private _enemyEquipment = GETMVAR(NATO_Enemy_EQUIPMENT_CIVILIAN,"");
    ...
    private _enemyAppearance = GETMVAR(NATO_Enemy_APPEARANCE_CIVILIAN,"");
    ...
    private _friendlyDisposition = GETMVAR(NATO_FRIENDLY_DIS_CIVILIAN,"");
    ...
    private _friendlyHigher = GETMVAR(NATO_FRIENDLY_DIS_CIVILIAN,"");
    ...
    private _friendlyStrength = GETMVAR(NATO_FRIENDLY_STRENGTH_CIVILIAN,"");
    ...
    private _friendlyAppearance = GETMVAR(NATO_FRIENDLY_APPEARANCE_CIVILIAN,"");
    ...
    private _missionNato = GETMVAR(NATO_Mission_CIVILIAN,"");
    ...
    private _execCIntent = GETMVAR(NATO_EXECUTION_INTENT_CIVILIAN,"");
    ...
    private _execManeuver = GETMVAR(NATO_EXECUTION_INTENT_CIVILIAN,"");
    ...
    private _execTimings = GETMVAR(NATO_EXECUTION_Timings_CIVILIAN,"");
    ...
    private _execTasks = GETMVAR(NATO_EXECUTION_Tasks_CIVILIAN,"");
    ...
    private _firesStr = GETMVAR(NATO_SANDS_SUPPORT_FIRES_CIVILIAN,"");
    ...
    private _ammoTasks = GETMVAR(NATO_SANDS_SUPPORT_AMMO_CIVILIAN,"");
    ...
    private _serviceGen = GETMVAR(NATO_SANDS_SERVICE_GENERAL_CIVILIAN,"");
    ...
    private _commandGen = GETMVAR(NATO_CANDS_COMMAND_CIVILIAN,"");
    ...
    private _signalFreq = GETMVAR(NATO_CANDS_Signals_FREQ_CIVILIAN,"");
    ...
    private _signalCode = GETMVAR(NATO_CANDS_Signals_CODEWORDS_CIVILIAN,"");
    ...
    private _signalSpec = GETMVAR(NATO_CANDS_Signals_SPECIAL_CIVILIAN,"");
    ...
    private _signalCall = GETMVAR(NATO_CANDS_Signals_CALLSIGNS_CIVILIAN,"");
    ...
    private _signalPass = GETMVAR(NATO_CANDS_Signals_PASSWORDS_CIVILIAN,"");
...
if (GETMVAR(Warsaw_CIVILIAN,false)) then {

    private _preStr = "";

    private _preWeather = GETMVAR(Warsaw_Preliminaries_Weather_CIVILIAN,"");
    if !(_preWeather isEqualTo "") then {
        _preStr = _preStr + "<font color='#5BD527' size='14.0'><h1>Weather:</h1></font color><br/>" + _preWeather + "<br/><br/>";
    };

    private _preTerrain = GETMVAR(Warsaw_Preliminaries_Terrain_CIVILIAN,"");
    ...
    private _refpointsDep = GETMVAR(Warsaw_Reference_DeploymentPoints_CIVILIAN,"");
    ...
    private _refpointsSub = GETMVAR(Warsaw_Reference_SubsequentPoints_CIVILIAN,"");
    ...
    private _enLoc = GETMVAR(Warsaw_Enemy_Prob_Line_CIVILIAN,"");
    ...
    private _enDir = GETMVAR(Warsaw_Enemy_Prob_Dir_Attack_CIVILIAN,"");
    ...
    private _enArty = GETMVAR(Warsaw_Enemy_Prob_Arty_CIVILIAN,"");
    ...
    private _higherDesc = GETMVAR(Warsaw_Higher_Disp_CIVILIAN,"");
    ...
    private _higherBound = GETMVAR(Warsaw_Higher_Boundary_CIVILIAN,"");
    ...
    private _higherLocArty = GETMVAR(Warsaw_Higher_Arty_CIVILIAN,"");
    ...
    private _missionStat = GETMVAR(Warsaw_Mission_Desc_CIVILIAN,"");
    ...
    private _missionDir = GETMVAR(Warsaw_Mission_DIR_CIVILIAN,"");
    ...
    private _orderTimings = GETMVAR(Warsaw_Order_Timings_CIVILIAN,"");
    ...
    private _orderSignals = GETMVAR(Warsaw_Order_Signals_CIVILIAN,"");
    ...
    private _cmdlocDesc = GETMVAR(Warsaw_COMM_LOC_CIVILIAN,"");
    ...
    private _succDesc = GETMVAR(Warsaw_SUCC_DESC_CIVILIAN,"");
...
if (GETMVAR(Appendix_CIVILIAN,false)) then {
    if !(GETMVAR(Appendix_Path_CIVILIAN,"") isEqualto "") then {
        "" call (compile preprocessFileLineNumbers (GETMVAR(Appendix_Path_CIVILIAN,"")));
    } else {
