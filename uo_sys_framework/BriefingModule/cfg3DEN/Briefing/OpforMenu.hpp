class UO_FW_OPFOR_NATOStyle {
    ...
    collapsed = 1;
    class Attributes {
        class UO_FW_Briefing_OPFOR_NATO {
            property = "UO_FW_Briefing_OPFOR_NATO";
            displayName = "NATO style briefing";
        ...
        class UO_FW_Briefing_OPFOR_NATO_SIT_Main {
            property = "UO_FW_Briefing_OPFOR_NATO_SIT_Main";
            displayName = "Situation";
            tooltip = "Situation";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_OPFOR_NATO_Enemy_Title {
            property = "UO_FW_Briefing_OPFOR_NATO_Enemy_Title";
            displayName = "Enemy";
            control = "SubTitle";
            expression = "true";
            defaultValue = "";
        ...
        class UO_FW_Briefing_OPFOR_NATO_FRIENDLY_Title {
            property = "UO_FW_Briefing_OPFOR_NATO_FRIENDLY_Title";
        ...
        class UO_FW_Briefing_OPFOR_NATO_FRIENDLY_APPEARANCE {
            property = "UO_FW_Briefing_OPFOR_NATO_FRIENDLY_APPEARANCE";
        ...
        class UO_FW_Briefing_OPFOR_NATO_Mission {
            property = "UO_FW_Briefing_OPFOR_NATO_Mission";
            displayName = "Mission";
            tooltip = "Mission";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_OPFOR_NATO_EXECUTION_MANEUVER {
            property = "UO_FW_Briefing_OPFOR_NATO_EXECUTION_MANEUVER";
        ...
        class UO_FW_Briefing_OPFOR_NATO_EXECUTION_Timings {
            property = "UO_FW_Briefing_OPFOR_NATO_EXECUTION_Timings";
            displayName = "Timings";
            tooltip = "Timings";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_OPFOR_NATO_EXECUTION_Tasks {
            property = "UO_FW_Briefing_OPFOR_NATO_EXECUTION_Tasks";
            displayName = "Tasks";
            tooltip = "Tasks";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_OPFOR_NATO_SANDS_SUPPORT_Title {
            property = "UO_FW_Briefing_OPFOR_NATO_SANDS_SUPPORT_Title";
            displayName = "Support";
            tooltip = "Support";
            control = "SubTitle";
            expression = "true";
        ...
        class UO_FW_Briefing_OPFOR_NATO_SANDS_SERVICE_Title {
            property = "UO_FW_Briefing_OPFOR_NATO_SANDS_SERVICE_Title";
            displayName = "Service";
            tooltip = "Service";
            control = "SubTitle";
            expression = "true";
        ...
        class UO_FW_Briefing_OPFOR_NATO_CANDS_COMMAND_Title {
            property = "UO_FW_Briefing_OPFOR_NATO_CANDS_COMMAND_Title";
            displayName = "Command";
            tooltip = "Command";
            control = "SubTitle";
            expression = "true";
        ...
        class UO_FW_Briefing_OPFOR_NATO_CANDS_Signals_Title {
            property = "UO_FW_Briefing_OPFOR_NATO_CANDS_Signals_Title";
            displayName = "Signals";
            tooltip = "Signals";
            control = "SubTitle";
            expression = "true";
...
class UO_FW_OPFOR_WPStyle {
    displayName = "Warsaw Pact Style Briefing";
    collapsed = 1;
    class Attributes {
        class UO_FW_Briefing_OPFOR_Warsaw {
            property = "UO_FW_Briefing_OPFOR_Warsaw";
            displayName = "Warsaw Pact style briefing";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Preliminaries_Weather {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Preliminaries_Weather";
            displayName = "Weather";
            tooltip = "Weather";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Preliminaries_Terrain {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Preliminaries_Terrain";
            displayName = "Terrain";
            tooltip = "Terrain";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Reference_DeploymentPoints {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Reference_DeploymentPoints";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Reference_SubsequentPoints {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Reference_SubsequentPoints";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Enemy_Disp {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Enemy_Disp";
            displayName = "Enemy Disposition";
            tooltip = "Enemy Disposition";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Enemy_Equip {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Enemy_Equip";
            displayName = "Enemy Equipment";
            tooltip = "Enemy Equipment";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Enemy_Prob_HQ {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Enemy_Prob_HQ";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Enemy_Prob_Line {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Enemy_Prob_Line";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Enemy_Prob_Dir_Attack {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Enemy_Prob_Dir_Attack";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Enemy_Prob_Arty {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Enemy_Prob_Arty";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Higher_Disp {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Higher_Disp";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Higher_Boundary {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Higher_Boundary";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Higher_Arty {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Higher_Arty";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Mission_Desc {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Mission_Desc";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Mission_DIR {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Mission_DIR";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Order_Tasks {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Order_Tasks";
            displayName = "Tasks";
            tooltip = "Tasks";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Order_Tasks_Arty {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Order_Tasks_Arty";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Order_Timings {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Order_Timings";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_Order_Signals {
            property = "UO_FW_Briefing_OPFOR_Warsaw_Order_Signals";
            displayName = "Signals";
            tooltip = "Signals";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_COMM_LOC {
            property = "UO_FW_Briefing_OPFOR_Warsaw_COMM_LOC";
            displayName = "Location of the Commander";
        ...
        class UO_FW_Briefing_OPFOR_Warsaw_SUCC_DESC {
            property = "UO_FW_Briefing_OPFOR_Warsaw_SUCC_DESC";
            displayName = "Succession of Command";
...
class UO_FW_OPFOR_Custom_File {
    displayName = "Briefing File";
    collapsed = 1;
    class Attributes {
        class UO_FW_Briefing_OPFOR_File {
            property = "UO_FW_Briefing_OPFOR_File";
            displayName = "Briefing File";
        ...
        class UO_FW_Briefing_OPFOR_File_Path {
            property = "UO_FW_Briefing_OPFOR_File_Path";
...
class UO_FW_OPFOR_Appendix {
    displayName = "Appendix Card File";
    collapsed = 1;
    class Attributes {
        class UO_FW_Briefing_OPFOR_Appendix {
            property = "UO_FW_Briefing_OPFOR_Appendix";
        ...
        class UO_FW_Briefing_OPFOR_Appendix_Path {
            property = "UO_FW_Briefing_OPFOR_Appendix_Path";
