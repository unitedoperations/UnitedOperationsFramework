class UO_FW_BLUFOR_NATOStyle {
    ...
    collapsed = 1;
    class Attributes {
        class UO_FW_Briefing_BLUFOR_NATO {
        ...
        class UO_FW_Briefing_BLUFOR_NATO_Situation_Title {
            property = "UO_FW_Briefing_BLUFOR_NATO_Situation_Title";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_SIT_Main {
            property = "UO_FW_Briefing_BLUFOR_NATO_SIT_Main";
            displayName = "Situation";
            tooltip = "Situation";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_Enemy_Title {
            property = "UO_FW_Briefing_BLUFOR_NATO_Enemy_Title";
            displayName = "Enemy";
            control = "SubTitle";
            expression = "true";
            defaultValue = "";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_FRIENDLY_Title {
            property = "UO_FW_Briefing_BLUFOR_NATO_FRIENDLY_Title";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_Mission {
            property = "UO_FW_Briefing_BLUFOR_NATO_Mission";
            displayName = "Mission";
            tooltip = "Mission";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_EXECUTION_Title {
            property = "UO_FW_Briefing_BLUFOR_NATO_EXECUTION_Title";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_EXECUTION_MANEUVER {
            property = "UO_FW_Briefing_BLUFOR_NATO_EXECUTION_MANEUVER";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_EXECUTION_Timings {
            property = "UO_FW_Briefing_BLUFOR_NATO_EXECUTION_Timings";
            displayName = "Timings";
            tooltip = "Timings";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_EXECUTION_Tasks {
            property = "UO_FW_Briefing_BLUFOR_NATO_EXECUTION_Tasks";
            displayName = "Tasks";
            tooltip = "Tasks";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_SANDS_Title {
            property = "UO_FW_Briefing_BLUFOR_NATO_SANDS_Title";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_SANDS_SUPPORT_Title {
            property = "UO_FW_Briefing_BLUFOR_NATO_SANDS_SUPPORT_Title";
            displayName = "Support";
            tooltip = "Support";
            control = "SubTitle";
            expression = "true";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_SANDS_SERVICE_Title {
            property = "UO_FW_Briefing_BLUFOR_NATO_SANDS_SERVICE_Title";
            displayName = "Service";
            tooltip = "Service";
            control = "SubTitle";
            expression = "true";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_CANDS_Title {
            property = "UO_FW_Briefing_BLUFOR_NATO_CANDS_Title";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_CANDS_COMMAND_Title {
            property = "UO_FW_Briefing_BLUFOR_NATO_CANDS_COMMAND_Title";
            displayName = "Command";
            tooltip = "Command";
            control = "SubTitle";
            expression = "true";
        ...
        class UO_FW_Briefing_BLUFOR_NATO_CANDS_Signals_Title {
            property = "UO_FW_Briefing_BLUFOR_NATO_CANDS_Signals_Title";
            displayName = "Signals";
            tooltip = "Signals";
            control = "SubTitle";
            expression = "true";
...
class UO_FW_BLUFOR_WPStyle {
    ...
    class Attributes {
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Preliminaries_Title {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Preliminaries_Title";
            displayName = "Preliminaries";
            control = "CategoryTitleIndent";
            expression = "true";
            defaultValue = "";
        };
        class UO_FW_Briefing_BLUFOR_Warsaw_Preliminaries_Weather {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Preliminaries_Weather";
            displayName = "Weather";
            tooltip = "Weather";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Preliminaries_Terrain {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Preliminaries_Terrain";
            displayName = "Terrain";
            tooltip = "Terrain";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Reference_Title {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Reference_Title";
            displayName = "Reference Points";
            control = "CategoryTitleIndent";
            expression = "true";
            defaultValue = "";
        };
        class UO_FW_Briefing_BLUFOR_Warsaw_Reference_DeploymentPoints {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Reference_DeploymentPoints";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Reference_SubsequentPoints {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Reference_SubsequentPoints";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Enemy_Title {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Enemy_Title";
            displayName = "Enemy";
            control = "CategoryTitleIndent";
            expression = "true";
            defaultValue = "";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Enemy_Prob_HQ {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Enemy_Prob_HQ";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Enemy_Prob_Line {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Enemy_Prob_Line";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Enemy_Prob_Dir_Attack {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Enemy_Prob_Dir_Attack";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Enemy_Prob_Arty {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Enemy_Prob_Arty";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Higher_Title {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Higher_Title";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Higher_Boundary {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Higher_Boundary";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Higher_Arty {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Higher_Arty";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Mission_Title {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Mission_Title";
            displayName = "Mission";
            control = "CategoryTitleIndent";
            expression = "true";
            defaultValue = "";
        };
        class UO_FW_Briefing_BLUFOR_Warsaw_Mission_Desc {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Mission_Desc";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Mission_DIR {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Mission_DIR";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Order_Title {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Order_Title";
            displayName = "Order";
            control = "CategoryTitleIndent";
            expression = "true";
            defaultValue = "";
        };
        class UO_FW_Briefing_BLUFOR_Warsaw_Order_Tasks {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Order_Tasks";
            displayName = "Tasks";
            tooltip = "Tasks";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Order_Tasks_Arty {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Order_Tasks_Arty";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Order_Timings {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Order_Timings";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_Order_Signals {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_Order_Signals";
            displayName = "Signals";
            tooltip = "Signals";
            control = "EditMulti5";
            validate = "STRING";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_COMM_Title {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_COMM_Title";
            displayName = "Location of the Commander";
            control = "CategoryTitleIndent";
            expression = "true";
            defaultValue = "";
        };
        class UO_FW_Briefing_BLUFOR_Warsaw_COMM_LOC {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_COMM_LOC";
            displayName = "Location of the Commander";
        ...
        class UO_FW_Briefing_BLUFOR_Warsaw_SUCC_Title {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_SUCC_Title";
            displayName = "Succession of Command";
            control = "CategoryTitleIndent";
            expression = "true";
            defaultValue = "";
        };
        class UO_FW_Briefing_BLUFOR_Warsaw_SUCC_DESC {
            property = "UO_FW_Briefing_BLUFOR_Warsaw_SUCC_DESC";
            displayName = "Succession of Command";
...
class UO_FW_BLUFOR_Custom_File {
    displayName = "Briefing File";
    collapsed = 1;
    class Attributes {
        class UO_FW_Briefing_BLUFOR_File {
            property = "UO_FW_Briefing_BLUFOR_File";
            displayName = "Briefing File";
        ...
        class UO_FW_Briefing_BLUFOR_File_Path {
            property = "UO_FW_Briefing_BLUFOR_File_Path";
