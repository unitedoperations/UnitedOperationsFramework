...
class EGVAR(Firemission,DIA_PointFiremission)
{
    ...
    class PFM_FIREBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
        shadow = 0;
        onMouseButtonDown = "[] call UO_FW_fnc_PointFiremission_DIA_PointFiremissionFire;";
    };
    class PFM_SELECTEDGUNEDIT: MGVAR(RscListbox)
    {
        ...
        //
        shadow = 0;
        onLBSelChanged = "(_this select 1) call UO_FW_fnc_PointFiremission_DIA_PointFiremissionSetArtillery;";
    };
    ...
    class PFM_CANCELBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
    shadow = 0;
            onMouseButtonDown = "[] call UO_FW_fnc_PointFiremission_DIA_PointFiremissionCloseDialog;";
    };
};
