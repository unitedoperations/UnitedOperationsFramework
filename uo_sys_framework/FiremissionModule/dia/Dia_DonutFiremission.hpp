...
class EGVAR(Firemission,DIA_DonutFiremission)
{
    ...
    class DFM_FIREBUTTON: MGVAR(RscButton)
    {
        ...
        w = ARTILAYOUTWIDTH * safezoneW;
        h = ARTILAYOUTHEIGHT * safezoneH;
            onMouseButtonDown = "[] call UO_FW_fnc_DonutFiremission_DIA_DonutFiremissionFire;";
    };
    class DFM_SELECTEDGUNEDIT: MGVAR(RscListbox)
    {
        ...
        //colorActive[] = {0,1,0,1};
        onLBSelChanged = "(_this select 1) call UO_FW_fnc_DonutFiremission_DIA_DonutFiremissionSetArtillery;";
    };
    ...
    class DFM_CANCELBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
            ...
            onMouseButtonDown = "[] call UO_FW_fnc_DonutFiremission_DIA_DonutFiremissionCloseDialog;";
    };
};
