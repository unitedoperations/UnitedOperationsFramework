...
class EGVAR(Firemission,DIA_BracketFiremission)
{
    ...
    class BFM_FIREBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
            ...
            onMouseButtonDown = "[] call UO_FW_fnc_BracketFiremission_DIA_BracketFiremissionFire;";
    };
    class BFM_SELECTEDGUNEDIT: MGVAR(RscListbox)
    {
        ...
        //colorActive[] = {0,1,0,1};
        onLBSelChanged = "(_this select 1) call UO_FW_fnc_BracketFiremission_DIA_BracketFiremissionSetArtillery;";
    };
    ...
    class BFM_CANCELBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
            ...
            onMouseButtonDown = "[] call UO_FW_FNC_BracketFiremission_DIA_BracketFiremissionCloseDialog;";
    };
};
