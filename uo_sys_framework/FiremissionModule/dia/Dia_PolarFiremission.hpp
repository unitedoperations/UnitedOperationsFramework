...
class EGVAR(Firemission,DIA_PolarFiremission)
{
    ...
    class POFM_FIREBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
    shadow = 0;
            onMouseButtonDown = "[] call UO_FW_fnc_PolarFiremission_DIA_PolarFiremissionFire;";
    };
    class POFM_SELECTEDGUNEDIT: MGVAR(RscListbox)
    {
        ...
        //
        shadow = 0;
        onLBSelChanged = "(_this select 1) call UO_FW_fnc_PolarFiremission_DIA_PolarFiremissionSetArtillery;";
    };
    ...
    class POFM_CANCELBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
    shadow = 0;
            onMouseButtonDown = "[] call UO_FW_fnc_PolarFiremission_DIA_PolarFiremissionCloseDialog;";
    };
};
