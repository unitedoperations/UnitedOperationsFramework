...
class EGVAR(Firemission,DIA_PolarSpottingFiremission)
{
    ...
    class PSFM_FIREBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
    shadow = 0;
            onMouseButtonDown = "[] call UO_FW_fnc_PolarSpottingFiremission_DIA_PolarSpottingFiremissionFire;";
    };
    class PSFM_SELECTEDGUNEDIT: MGVAR(RscListbox)
    {
        ...
        //
        shadow = 0;
        onLBSelChanged = "(_this select 1) call UO_FW_fnc_PolarSpottingFiremission_DIA_PolarSpottingFiremissionSetArtillery;";
    };
    ...
    class PSFM_CANCELBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
    shadow = 0;
            onMouseButtonDown = "[] call UO_FW_fnc_PolarSpottingFiremission_DIA_PolarSpottingFiremissionCloseDialog;";
    };
};
