...
class EGVAR(Firemission,DIA_MarkerFiremission)
{
    ...
    class MFM_FIREBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
    shadow = 0;
            onMouseButtonDown = "[] call UO_FW_fnc_MarkerFiremission_DIA_MarkerFiremissionFire;";
    };
    class MFM_SELECTEDGUNEDIT: MGVAR(RscListbox)
    {
        ...
        //
        shadow = 0;
        onLBSelChanged = "(_this select 1) call UO_FW_fnc_MarkerFiremission_DIA_MarkerFiremissionSetArtillery;";
    };
    ...
    class MFM_CANCELBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
    shadow = 0;
            onMouseButtonDown = "[] call UO_FW_fnc_MarkerFiremission_DIA_MarkerFiremissionCloseDialog;";
    };
};
