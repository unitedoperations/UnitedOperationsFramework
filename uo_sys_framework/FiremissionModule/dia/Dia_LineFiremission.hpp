...
class EGVAR(Firemission,DIA_LineFiremission)
{
    ...
    class LFM_FIREBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
            ...
            onMouseButtonDown = "[] call UO_FW_fnc_LineFiremission_DIA_LineFiremissionFire;";
    };
    class LFM_SELECTEDGUNEDIT: MGVAR(RscListbox)
    {
        ...
        //colorActive[] = {0,1,0,1};
        onLBSelChanged = "(_this select 1) call UO_FW_fnc_LineFiremission_DIA_LineFiremissionSetArtillery;";
    };
    ...
    class LFM_CANCELBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
            ...
            onMouseButtonDown = "[] call UO_FW_fnc_LineFiremission_DIA_LineFiremissionCloseDialog;";
    };
};
