...
class EGVAR(Firemission,DIA_GridSpottingFiremission)
{
    ...
    class GSFM_FIREBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
    shadow = 0;
            onMouseButtonDown = "[] call UO_FW_fnc_GridSpottingFiremission_DIA_GridSpottingFiremissionFire;";
    };
    class GSFM_SELECTEDGUNEDIT: MGVAR(RscListbox)
    {
        ...
        //
        shadow = 0;
        onLBSelChanged = "(_this select 1) call UO_FW_fnc_GridSpottingFiremission_DIA_GridSpottingFiremissionSetArtillery;";
    };
    ...
    class GSFM_CANCELBUTTON: MGVAR(RscButton)
    {
        ...
        h = ARTILAYOUTHEIGHT * safezoneH;
    shadow = 0;
            onMouseButtonDown = "[] call UO_FW_fnc_GridSpottingFiremission_DIA_GridSpottingFiremissionCloseDialog;";
    };
};
