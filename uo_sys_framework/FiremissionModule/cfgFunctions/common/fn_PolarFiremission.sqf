...
private _unit = _this select 0;
    ...
    [_unit,_loc vectorAdd (_dir vectorMultiply _distance),_dispersion,_salvoCount,_salvoSize,_salvoWait,_minSpottedDistance,_roundType] call EFUNC(Firemission,PointFiremission);