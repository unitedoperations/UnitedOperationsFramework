...
_requester  = _this select 0;
    ...
    [_selectedUnit ,[_grid,true] call CBA_fnc_mapGridToPos,_innerRadius,_outerRadius,_salvoNumber,_salvoRounds,_salvoDelay,_spotting,_selectedAmmo]   call EFUNC(Firemission,DonutFiremission);