...
["UO_FW_SelfActions_ParaFlaresInitEvent", {
    [{!isNull player}, {
        ...
        [player, 1, ["ACE_SelfActions","ACE_Equipment"], _paraFlareBaseMenu] call ace_interact_menu_fnc_addActionToObject;
        {
            ...
            ["Large White","UO_FW_HandFlare_White",[1,1,1],"UO_FW_HandFlare_Shot_White"],
            ["Large Green","UO_FW_HandFlare_Green",[0.25,0.5,0.25],"UO_FW_HandFlare_Shot_Green"],
            ["Large Yellow","UO_FW_HandFlare_Yellow",[0.5,0.5,0.25],"UO_FW_HandFlare_Shot_Yellow"],
            ["Large Red","UO_FW_HandFlare_Red",[0.5,0.25,0.25],"UO_FW_HandFlare_Shot_Red"]
        ];
    }, []] call CBA_fnc_waitUntilAndExecute;
}] call CBA_fnc_addEventHandler;
