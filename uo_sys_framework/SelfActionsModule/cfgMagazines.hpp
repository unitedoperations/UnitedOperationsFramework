...
class UO_FW_HandFlare_White: ACE_HandFlare_Base {
    displayname = "White Para Flare";
    displayNameShort = "White Para Flare";
    model = "\A3\weapons_f\ammo\flare_white";
    picture = "\A3\Weapons_F\Data\UI\gear_flare_white_ca.paa";
    ammo = "UO_FW_HandFlare_Shot_White";
    mass = 2;
};
class UO_FW_HandFlare_Green: ACE_HandFlare_Base {
    displayname = "Green Para Flare";
    displayNameShort = "Green Para Flare";
    model = "\A3\weapons_f\ammo\flare_green";
    picture = "\A3\Weapons_F\Data\UI\gear_flare_green_ca.paa";
    ammo = "UO_FW_HandFlare_Shot_Green";
    mass = 2;
};
class UO_FW_HandFlare_Red: ACE_HandFlare_Base {
    displayname = "Red Para Flare";
    displayNameShort = "Red Para Flare";
    model = "\A3\weapons_f\ammo\flare_red";
    picture = "\A3\Weapons_F\Data\UI\gear_flare_red_ca.paa";
    ammo = "UO_FW_HandFlare_Shot_Red";
    mass = 2;
};
class UO_FW_HandFlare_Yellow: ACE_HandFlare_Base {
    ...
    ammo = "UO_FW_HandFlare_Shot_Yellow";
    mass = 2;
};
