...
["UO_FW_AntiND_Event", {
    ...
    [{(!isNull player)}, {
        ...
        [{(CBA_missionTime > UO_FW_Anti_ND_Time)},{player removeEventHandler ["Fired", _this]; SETPLVAR(ND_EHid,"DISABLED"); SETPLVAR(ND_Active,false);},_FiredEh] call CBA_fnc_waitUntilAndExecute;
