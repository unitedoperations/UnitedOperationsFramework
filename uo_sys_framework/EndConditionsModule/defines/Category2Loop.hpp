		...
		if ((_conditionsCountCategory2) > 0) then {
			...
			private _endConditionsCategory2PFHhandle = [{
				...
				if (UO_FW_EndCondition_ExtractionEnabled_2) then {
					private _team = ([UO_FW_TeamSetting_Blufor_TeamName,UO_FW_TeamSetting_Opfor_TeamName,UO_FW_TeamSetting_Indfor_TeamName,UO_FW_TeamSetting_Civ_TeamName] select UO_FW_EndCondition_ExtractionTeam_2);
