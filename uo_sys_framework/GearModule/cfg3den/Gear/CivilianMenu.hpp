class EGVAR(Gear,Presets_Civ) {
    displayName = "Civilian Gear Presets";
    collapsed = 0;
    class Attributes {
        class EGVAR(Gear,ACE_Arsenal_GearPresets_Civ) {
            property = QEGVAR(Gear,ACE_Arsenal_GearPresets_Civ);
            displayName = "Gear Presets";
            tooltip = "";
            control = QEGVAR(Gear,PresetsCombo_Civ);
            typeName = "STRING";
...
class EGVAR(Gear,ACE_Arsenal_Civ) {
