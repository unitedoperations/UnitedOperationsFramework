...
class EGVAR(Acre,SETTINGS_RADIONET_CAT_OPFOR) {
    displayName = "Radio Net Configuration";
    collapsed = 0;
    class Attributes {
        class EGVAR(Acre,RADIONET_Enabled_OPFOR) {
            property = QEGVAR(RADIONET_Enabled_OPFOR);
        ...
        class EGVAR(Acre,RADIONET_NAME1_OPFOR) {
            property = QEGVAR(RADIONET_NAME1_OPFOR);
        ...
        class EGVAR(Acre,RADIONET_NAME2_OPFOR) {
            property = QEGVAR(RADIONET_NAME2_OPFOR);
        ...
        class EGVAR(Acre,RADIONET_NAME3_OPFOR) {
            property = QEGVAR(RADIONET_NAME3_OPFOR);
        ...
        class EGVAR(Acre,RADIONET_NAME4_OPFOR) {
            property = QEGVAR(RADIONET_NAME4_OPFOR);
        ...
        class EGVAR(Acre,RADIONET_NAME5_OPFOR) {
            property = QEGVAR(RADIONET_NAME5_OPFOR);
        ...
        class EGVAR(Acre,RADIONET_NAME6_OPFOR) {
            property = QEGVAR(RADIONET_NAME6_OPFOR);
        ...
        class EGVAR(Acre,RADIONET_NAME7_OPFOR) {
            property = QEGVAR(RADIONET_NAME7_OPFOR);
...
class EGVAR(Acre,SETTINGS_BABEL_CAT_OPFOR) {
