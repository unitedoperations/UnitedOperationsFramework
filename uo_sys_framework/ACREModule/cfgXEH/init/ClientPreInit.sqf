...
["UO_FW_SettingsLoaded",
{
    ...
    if (!isDedicated && hasinterface) then
    {
        ...
        private _UO_FW_Presets_CIV = "default";
        if (UO_FW_ACRE_SCRAMBLE_Enabled) then
        {
            ...
            _UO_FW_Presets_CIV = _UO_FW_Presets select 3;
        };
        //blu,opf,indep,civ
        ...
        if (UO_FW_ACRE_CIV_RADIONET_Enabled   && (side player == civilian)) then {
            ...
            _UO_FW_ChannelNamesCIVILIAN pushBack (missionNamespace getVariable ["UO_FW_ACRE_CIV_RADIONET_NAME1",""]);
            _UO_FW_ChannelNamesCIVILIAN pushBack (missionNamespace getVariable ["UO_FW_ACRE_CIV_RADIONET_NAME2",""]);
            _UO_FW_ChannelNamesCIVILIAN pushBack (missionNamespace getVariable ["UO_FW_ACRE_CIV_RADIONET_NAME3",""]);
            _UO_FW_ChannelNamesCIVILIAN pushBack (missionNamespace getVariable ["UO_FW_ACRE_CIV_RADIONET_NAME4",""]);
            _UO_FW_ChannelNamesCIVILIAN pushBack (missionNamespace getVariable ["UO_FW_ACRE_CIV_RADIONET_NAME5",""]);
            _UO_FW_ChannelNamesCIVILIAN pushBack (missionNamespace getVariable ["UO_FW_ACRE_CIV_RADIONET_NAME6",""]);
            _UO_FW_ChannelNamesCIVILIAN pushBack (missionNamespace getVariable ["UO_FW_ACRE_CIV_RADIONET_NAME7",""]);
            {
                private _index = _forEachIndex + 1;
                _x params ["_name"];
                if (_name != "") then {
                    {
                        private _label = [_x, "label"] call acre_api_fnc_mapChannelFieldName;
                        [_x, _UO_FW_Presets_CIV, _index, _label, _name] call acre_api_fnc_setPresetChannelField;
                    } forEach ["ACRE_PRC117F", "ACRE_PRC148", "ACRE_PRC152"];
                };
        ...
        [{(!isNull player) && (!isNull acre_player) && ([] call acre_api_fnc_isInitialized) && {UO_FW_GearReady}},
        {
            ...
            switch (_side) do {
                ...
                default {
                    _presetTemp = _UO_FW_Presets_CIV;
                };
            };
            ...
            if (UO_FW_ACRE_BABEL_Enabled) then
            {
                ...
                private _UO_FW_ACRE_CIV_BABEL_LANGUAGES = [];
                if (UO_FW_ACRE_CIV_BABEL_EN) then {_UO_FW_ACRE_CIV_BABEL_LANGUAGES pushBack "en"; };
                if (UO_FW_ACRE_CIV_BABEL_RU) then {    _UO_FW_ACRE_CIV_BABEL_LANGUAGES pushBack "ru"; };
                if (UO_FW_ACRE_CIV_BABEL_FR) then {_UO_FW_ACRE_CIV_BABEL_LANGUAGES pushBack "fr"; };
                if (UO_FW_ACRE_CIV_BABEL_AR) then {_UO_FW_ACRE_CIV_BABEL_LANGUAGES pushBack "ar"; };
                if (UO_FW_ACRE_CIV_BABEL_GK) then {    _UO_FW_ACRE_CIV_BABEL_LANGUAGES pushBack "gk"; };
                {
                    private _language = _x;
                    {
                        if (_language select 1 == missionNamespace getVariable [_x,""] &&  missionNamespace getVariable [_x,""] != "" ) then {
                            _UO_FW_ACRE_CIV_BABEL_LANGUAGES pushBack (_language select 0);
                        };
                ...
                if (UO_FW_ACRE_CIV_BABEL_Enabled  && (side player == civilian)) then {
                            _UO_FW_ACRE_CIV_BABEL_LANGUAGES call acre_api_fnc_babelSetSpokenLanguages;
    ...
    [{UO_FW_GearReady},
    {
        ...
        if (player getVariable ["UO_FW_ACRE_UNITSETTINGS_Enable",false]) then
        {
            ...
            switch (side player) do 
            {
                ...
                case civilian: {
                    _SRType = ["NONE","ACRE_PRC343","ACRE_SEM52SL"] select UO_FW_ACRE_CIV_SR_Type;
                    _LRType = ["NONE","ACRE_PRC148","ACRE_PRC152"] select UO_FW_ACRE_CIV_LR_Type;
                    _PKType = ["NONE","ACRE_PRC117F","ACRE_PRC77","ACRE_SEM70"] select UO_FW_ACRE_CIV_PK_Type;
                };
                default {};
            };
