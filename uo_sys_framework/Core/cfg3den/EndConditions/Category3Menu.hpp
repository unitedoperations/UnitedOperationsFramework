...
class EGVAR(EndConditions,CasualtySettings_Category3) {
    ...
    collapsed = 0;
    class Attributes {
        class EGVAR(EndConditions,CasualtyCount_BLUFOR_Enabled_3) {
            property = QEGVAR(EndConditions,CasualtyCount_BLUFOR_Enabled_3);
        ...
        class EGVAR(EndConditions,CasualtyCount_BLUFOR_Percentage_3) {
            property = QEGVAR(EndConditions,CasualtyCount_BLUFOR_Percentage_3);
        ...
        class EGVAR(EndConditions,CasualtyCount_OPFOR_Enabled_3) {
            property = QEGVAR(EndConditions,CasualtyCount_OPFOR_Enabled_3);
        ...
        class EGVAR(EndConditions,CasualtyCount_OPFOR_Percentage_3) {
            property = QEGVAR(EndConditions,CasualtyCount_OPFOR_Percentage_3);
            displayName = "Casualty Percentage";
            tooltip = "End condition fires when team casualty percentage is over this number";
            control = "UO_FW_5To100Step5_Slider";
            expression = UO_FW_SCENARIO_EXPRESSION;
        ...
        class EGVAR(EndConditions,CasualtyCount_INDFOR_Enabled_3) {
            property = QEGVAR(EndConditions,CasualtyCount_INDFOR_Enabled_3);
        ...
        class EGVAR(EndConditions,CasualtyCount_INDFOR_Percentage_3) {
            property = QEGVAR(EndConditions,CasualtyCount_INDFOR_Percentage_3);
            displayName = "Casualty Percentage";
            tooltip = "End condition fires when team casualty percentage is over this number";
            control = "UO_FW_5To100Step5_Slider";
            expression = UO_FW_SCENARIO_EXPRESSION;
        ...
        class EGVAR(EndConditions,CasualtyCount_CIV_Enabled_3) {
            property = QEGVAR(EndConditions,CasualtyCount_CIV_Enabled_3);
        ...
        class EGVAR(EndConditions,CasualtyCount_CIV_Percentage_3) {
            property = QEGVAR(EndConditions,CasualtyCount_CIV_Percentage_3);
            displayName = "Casualty Percentage";
            tooltip = "End condition fires when team casualty percentage is over this number";
            control = "UO_FW_5To100Step5_Slider";
            expression = UO_FW_SCENARIO_EXPRESSION;
