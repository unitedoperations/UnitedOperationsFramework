        ...
        if ((_conditionsCountCategory4) > 0) then {
            ...
            private _endConditionsCategory4PFHhandle = [{
                ...
                if (UO_FW_EndCondition_ExtractionEnabled_4) then {
                    private _team = ([UO_FW_TeamSetting_Blufor_TeamName,UO_FW_TeamSetting_Opfor_TeamName,UO_FW_TeamSetting_Indfor_TeamName,UO_FW_TeamSetting_Civ_TeamName] select UO_FW_EndCondition_ExtractionTeam_4);
