...
params ["_veh","_pos"];
private _vehInit = (UO_FW_GETVAR(_veh,AI_vehInit,"true"));
...
(UO_FW_GETVAR(_veh,AI_vehName,"")),
(UO_FW_GETVAR(_veh,AI_vehPersistent,true)),
_vehInit,
_vehGearSystemType,
_vehGearType,
(UO_FW_GETVAR(_veh,AI_vehFlying,false)),
(UO_FW_GETVAR(_veh,AI_vehFlyInHeight,250))]
