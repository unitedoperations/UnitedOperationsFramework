...
private _groupInit = _group getVariable ["UO_FW_AI_groupInit","true"];
...
_occupy,
_vehAssigned,
([(waypoints _unit)] call UO_FW_AI_fnc_getWaypointDetails),
(surfaceIsWater (getposATL _unit)),
([_group,["UO_FW_AI_TaskModule"]] call UO_FW_AI_fnc_getTasks),
