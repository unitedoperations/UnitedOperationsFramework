class UO_Framework_AI
{
	...
	class UO_FW_AI_Misc {
		...
		class UO_FW_AI_Combat {
			...
			class DefaultGroupPatrol {scope = 1;};
			...
			class Garrison {scope = 1;};
			class GarrisonClear {scope = 1;};
			class GarrisonClearPatrol {scope = 1;};
			class GroupLoiter {scope = 1;};
			class GroupPatrol {scope = 1;};
			class LightGarrison {scope = 1;};
