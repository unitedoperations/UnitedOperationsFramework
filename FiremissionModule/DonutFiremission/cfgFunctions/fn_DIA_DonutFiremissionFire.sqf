...
_guns = player getVariable [VAR_SART_OBSGUNS,[]];
	...
	if(_inputIsCorrect ) then
	{
								...
								hint (([_selectedUnit,_grid call CBA_fnc_mapGridToPos,_innerRadius,_outerRadius,_burstNumber,_burstRounds,_burstDelay,_spotting,_selectedAmmo] call UO_FW_FNC_GetDonutFiremissionText)
