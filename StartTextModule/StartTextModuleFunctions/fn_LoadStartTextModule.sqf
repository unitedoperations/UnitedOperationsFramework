...
if (_activated) then
{
    ...
    if (!isDedicated) then
    {
        ...
        _dateType = _logic getVariable ["TimeSelectArgument","DATETIME"];
        ...
        { //Checks what team the player is on
            ...
            { //If player is west he receives this message
                ...
                if(_titleQuote != "" ) then {_startTextArray append ["TITLE", _titleQuote];};
                if(_titleQuote != "" ) then {_startTextArray append ["TEXT", _titleQuote];};
