class CasualtyCount_CAT_BLUFOR
{
    displayName = "BLUFOR Casualty Count";
    collapsed = 1;
    class Attributes
    {
        class UO_FW_CasualtyCount_BLUFOR_Enabled
        {
            property = "UO_FW_CasualtyCount_BLUFOR_Enabled";
        ...
        class UO_FW_CasualtyCount_BLUFOR_Percentage
        {
            property = "UO_FW_CasualtyCount_BLUFOR_Percentage";
		...
		class UO_FW_CasualtyCount_BLUFOR_EndCondition_Apply
        {
            property = "UO_FW_CasualtyCount_BLUFOR_EndCondition_Apply";
